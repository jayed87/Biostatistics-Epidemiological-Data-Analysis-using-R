...
##################################################################################################################################################################
## Scenario 3a: log-normally-distributed residuals
...
for(i in 1:10000){
  print(i)
  X1 <- rnorm(1000, mean=0, sd=1)
  Y	<- 0.3*X1 + rlnorm(1000, meanlog = 0, sdlog = 3)
  help <- summary(lm(Y~X1))$coefficients
  b1[i]      <- help[2,1]
  b1_SE[i]   <- help[2,2]
  b1_pval[i] <- help[2,4]
...
##################################################################################################################################################################
## Scenario 3b: log-normally-distributed residuals, with larger variance (i.e. more extreme)
...
> summary(b1)
Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
-5610.085   -12.456     0.393     1.315    13.439  2738.958 
> summary(b1_SE)
Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
2.603    11.940    19.647    43.627    36.493 11318.547 
> sd(b1)
[1] 121.9657
> summary(b1_pval)
Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
0.0000147 0.2497415 0.5046159 0.5008333 0.7493536 0.9998586 
